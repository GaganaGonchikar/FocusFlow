                        ...
                        <Row>
                            <Col>
                                ...
                                <Form.Group className="mb-3" controlId="formBasicEmail">
                                    <Form.Label className='required-field'>Employee Name</Form.Label>
                                    <Form.Control type="text" required placeholder="E.g. Robert Bosch" value={nm_value} onChange={e => setNmValue(e.target.value)} />
                            ...
                            <Col>
                                <Form.Group className="mb-3" controlId="formBasicEmail">
                                    ...
                                    <Form.Control type="email" required placeholder="E.g. abc@bosch.com" value={em_value} onChange={e => setEmValue(e.target.value)}/>
                                </Form.Group>
